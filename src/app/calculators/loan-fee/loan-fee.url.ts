...
/**
 * Converts URL search params directly to FormState for the loan fee calculator
...
/**
 * Generates shareable URL state for loan fee calculator
...
export function generateShareableUrlState(
  ...
  if (formState.formValues.feePercentage) {
    params.set("feePercentage", formState.formValues.feePercentage);
  }
