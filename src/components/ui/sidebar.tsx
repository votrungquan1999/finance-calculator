...
function SidebarProvider({
  ...
  // Track if the component has mounted to prevent hydration issues
  ...
  // Read cookie value after component mounts to avoid hydration mismatch
  React.useEffect(() => {
    setMounted(true);
    const savedState = Cookies.get(SIDEBAR_COOKIE_NAME);
    if (savedState !== undefined && !openProp) {
